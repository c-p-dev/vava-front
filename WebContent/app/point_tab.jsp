					...
					<div class="my_search_wrap">
						<table cellspacing="0" cellpadding="0" class="my_search_select">
							<tr>
								...
								<!-- <td><input class="input_style04"  placeholder="기간" value="2017-00-00 ~ 2017-00-00">
									<a href="#" id="showCalendarBtn"><img src="../images/car_icon.jpg"></a>
...
<script>
	...
	$(document).ready(function(){
        ...
        $(".dt-point-tab, .accordion_title.acc_head").on("click",function(){
  			setTimeout(function() {
