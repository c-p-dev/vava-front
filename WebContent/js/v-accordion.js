...
angular.module('vAccordion.config', [])
  .constant('accordionConfig', {
    ...
    expandAnimationDuration: 0.3
  })  
 //  .animation('.is-expanded', [ 'usSpinnerService', '$animateCss', 'accordionConfig', function (usSpinnerService, $animateCss, accordionConfig) {
  .animation('.is-expanded', ['$animateCss', 'accordionConfig', function ($animateCss, accordionConfig) {
 //.animation('.is-expanded', [ 'accordionConfig', function (accordionConfig) {
    return {
