...
<%
	...
	List<GameBean> allmgame_list	= game_dao.getAllMinigames();
	List<GameBean> lgame_list		= game_dao.getLadderGames();
					...
					<div id="tab1" class="tab_content">
						...
						<div class="casino_board_wrap">
							...
							<ul class="racing_board_list">
								...
								<%
									for (int i = 0; i < allmgame_list.size(); i++) {
										GameBean cur_vgame = allmgame_list.get(i);
								%>
								<li>
					...
					<div id="tab1" class="tab_content">
						<div class="casino_board_wrap">
							...
							<ul class="racing_board_list">
								...
								<%
									for (int i = 0; i < lgame_list.size(); i++) {
										GameBean cur_igame = lgame_list.get(i);
								%>
								<li>
