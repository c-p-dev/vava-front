...
import controller.AsianGamingController;
...
public class AsianGamingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		switch (Integer.valueOf(method)) {
			...
			case 2:
				String srv_resp_2	= ag_ctrl.createAgSession(username, session_id, 1);
			...
			case 4:
				String srv_resp_4	= ag_ctrl.launchGame(username, "22", 1);
