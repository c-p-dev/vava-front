...
public class NoticeEventBean {
	...
	public void setViewout(String viewout) {
	...
	public String getPopup_kind() {
		return popup_kind;
	}
	public void setPopup_kind(String popup_kind) {
		this.popup_kind = popup_kind;
	}
